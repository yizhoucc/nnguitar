...
class PedalNet(pl.LightningModule):
    def __init__(self, arg):
        ...
        self.wavenet = WaveNet(
            ...
            dilation_depth=arg['dilation_depth'],
            num_repeat=arg['num_repeat'],
    ...
    def val_dataloader(self):
        return DataLoader(
            self.valid_ds, batch_size=self.arg['batch_size'], num_workers=4
        )
